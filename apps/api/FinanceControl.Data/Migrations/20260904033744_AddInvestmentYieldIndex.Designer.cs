...
namespace FinanceControl.Data.Migrations
{
    ...
    [Migration("20260904033744_AddInvestmentYieldIndex")]
    partial class AddInvestmentYieldIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.Account", b =>
                {
                    ...
                    b.Property<int?>("BillingClosingDay")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.LegalDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CardClosingDaysAhead")
                        .HasColumnType("integer");

                    b.Property<bool>("CardClosingEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("CardDueDaysAhead")
                        .HasColumnType("integer");

                    b.Property<bool>("CardDueEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("RecurrenceChargedEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserAiContext", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserAiContexts", (string)null);
                });

            modelBuilder.Entity("FinanceControl.Domain.Entities.UserConsent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserInsight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "Kind", "PeriodStart")
                        .IsUnique()
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserRiskProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("LossTolerance")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");

                    b.Property<int>("ReserveMonthsTarget")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserConsent", b =>
                {
                    b.HasOne("FinanceControl.Domain.Entities.LegalDocument", "LegalDocument")
                        .WithMany("Consents")
            ...
            modelBuilder.Entity("FinanceControl.Domain.Entities.UserRiskProfile", b =>
                {
                    b.HasOne("FinanceControl.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("FinanceControl.Domain.Entities.UserRiskProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
