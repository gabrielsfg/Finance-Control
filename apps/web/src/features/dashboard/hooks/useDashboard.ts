...
const MOCK_DATA: DashboardSummary = {
  ...
  budgetSummary: {
    ...
    hasAllocations: true,
    topSubCategories: [
      { subCategoryName: "Aluguel", categoryName: "Moradia", categoryColor: "#4A9EFF", spent: 220000, allocated: 220000, spentPercentage: 100 },
      { subCategoryName: "Supermercado", categoryName: "Alimentação", categoryColor: "#F5A623", spent: 31240, allocated: 50000, spentPercentage: 62.5 },
      { subCategoryName: "Delivery", categoryName: "Alimentação", categoryColor: "#F5A623", spent: 8990, allocated: 20000, spentPercentage: 44.9 },
      { subCategoryName: "Combustível", categoryName: "Transporte", categoryColor: "#00C98D", spent: 18000, allocated: 25000, spentPercentage: 72 },
    ],
  },
  topCategories: [
    { categoryName: "Alimentação", color: "#F5A623", totalSpent: 60220 },
    { categoryName: "Moradia", color: "#4A9EFF", totalSpent: 246510 },
    { categoryName: "Transporte", color: "#00C98D", totalSpent: 48350 },
    { categoryName: "Lazer", color: "#7C6FE0", totalSpent: 12480 },
    { categoryName: "Saúde", color: "#F25F5C", totalSpent: 16770 },
  ],
};
