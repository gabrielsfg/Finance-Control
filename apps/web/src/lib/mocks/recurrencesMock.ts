...
export const MOCK_RECURRENCES: RecurrencePageData = {
  // kept for reference — UI now calculates net from items directly
  ...
  recurring: [
    ...
    },
    {
      id: 8,
      subCategoryId: 81,
      subCategoryName: "Aluguel recebido",
      categoryId: 11,
  ...
  installments: [
    ...
    },
    {
      ...
      totalValue: 240000,
      type: "Income",
      description: "Venda do Carro (Civic)",
      transactionDate: "2025-11-01",
      totalInstallments: 12,
      paidInstallments: 6,
